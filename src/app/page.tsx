      ...
      <main className="h-[100dvh] flex flex-col justify-between items-center text-center pt-20 sm:pt-24 pb-4 sm:pb-5 bg-white relative overflow-hidden w-full">
        ...
        >
          ...
          <div className="flex items-center justify-center mt-3 sm:mt-4">
            <a href="https://instagram.com/getnenge" target="_blank" rel="noopener noreferrer" className="text-black/60 hover:text-black transition-colors duration-200 cursor-pointer" aria-label="Instagram">
